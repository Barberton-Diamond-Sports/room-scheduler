    ...
    <main style={{ minHeight: "100vh", backgroundColor: "#f5f7fb", padding: "2rem", fontFamily: "Arial, sans-serif" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gap: "1rem", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", marginBottom: "1.5rem" }}>
          ...
          <div style={{ backgroundColor: "#ffffff", border: "1px solid #dbe3f0", borderRadius: "16px", padding: "1.25rem", boxShadow: "0 6px 18px rgba(0, 0, 0, 0.05)" }}><div style={{ color: "#64748b", fontSize: "0.9rem", marginBottom: "0.4rem" }}>Active Umpires</div><div style={{ fontSize: "1.6rem", fontWeight: 700, color: "#0f172a" }}>{umpireCount}</div></div>
        </div>
